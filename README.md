...
> OpenAPI 3.1 specification for the ADAMANT Node API, with interactive Swagger UI.
...
- [OpenAPI Specification](https://swagger.io/specification/) — OpenAPI 3.1 standard
